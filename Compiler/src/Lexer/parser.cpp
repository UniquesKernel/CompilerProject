...
static const char *const yytname[] =
{
  ...
  "'+'", "'-'", "LPAREN", "RPAREN", "END_OF_LINE", "END_OF_FILE",
  "$accept", "start", "program", "expr", YY_NULLPTR
};
