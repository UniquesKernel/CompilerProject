...
enum yysymbol_kind_t {
  ...
  YYSYMBOL_END_OF_LINE = 10, /* END_OF_LINE  */
  YYSYMBOL_END_OF_FILE = 11, /* END_OF_FILE  */
...
static const yytype_int8 yytranslate[] = {
    ...
    2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 4, 6, 2, 7,  2, 5,
    ...
    2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2,  2, 2,
    2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2,  2, 2,
    2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 1, 2, 3, 8, 9, 10, 11};

#if YYDEBUG
/* YYRLINE[YYN] -- Source line where rule number YYN was defined.  */
static const yytype_int8 yyrline[] = {0,  44, 44, 47, 49, 53,
                                      54, 55, 56, 64, 65};
#endif
...
/* YYPACT[STATE-NUM] -- Index in YYTABLE of the portion describing
   STATE-NUM.  */
static const yytype_int8 yypact[] = {-4, 3,  -3, -4, -4, -1, -4, 10, 17, -1,
                                     -1, -1, -1, -4, -4, 0,  14, 14, 23};

/* YYDEFACT[STATE-NUM] -- Default reduction number in state STATE-NUM.
   Performed when YYTABLE does not specify something else to do.  Zero
   means the default is an error.  */
static const yytype_int8 yydefact[] = {3, 0, 0, 1, 6, 0, 2, 0, 0, 0,
                                       0, 0, 0, 4, 5, 7, 8, 9, 10};

/* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] = {-4, -4, -4, 1};

/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] = {0, 1, 2, 7};

/* YYTABLE[YYPACT[STATE-NUM]] -- What to do in state STATE-NUM.  If
   positive, shift that token.  If negative, reduce the rule whose
   number is the opposite.  If YYTABLE_NINF, syntax error.  */
static const yytype_int8 yytable[] = {4,  0,  4,  3,  9,  5,  8,  5,  6,  0,
                                      15, 16, 17, 18, 9,  10, 11, 12, 9,  10,
                                      13, 9,  10, 11, 12, 0,  14, 9,  10, 11};

static const yytype_int8 yycheck[] = {3,  -1, 3,  0,  4, 8,  5, 8, 11, -1,
                                      9,  10, 11, 12, 4, 5,  6, 7, 4,  5,
                                      10, 4,  5,  6,  7, -1, 9, 4, 5,  6};

/* YYSTOS[STATE-NUM] -- The symbol kind of the accessing symbol of
   state STATE-NUM.  */
static const yytype_int8 yystos[] = {0, 13, 14, 0,  3, 8,  11, 15, 15, 4,
                                     5, 6,  7,  10, 9, 15, 15, 15, 15};

/* YYR1[RULE-NUM] -- Symbol kind of the left-hand side of rule RULE-NUM.  */
static const yytype_int8 yyr1[] = {0, 12, 13, 14, 14, 15, 15, 15, 15, 15, 15};

/* YYR2[RULE-NUM] -- Number of symbols on the right-hand side of rule RULE-NUM.
 */
static const yytype_int8 yyr2[] = {0, 2, 2, 0, 3, 3, 1, 3, 3, 3, 3};
...
yyreduce:
  ...
  YY_REDUCE_PRINT(yyn);
  switch (yyn) {
  case 2: /* start: program END_OF_FILE  */
#line 44 "parser.y"
  {
    return 0;
  }
#line 1203 "parser.cpp"
  ...
  case 4: /* program: program expr END_OF_LINE  */
#line 49 "parser.y"
  {
    appendResult((yyvsp[-1].num));
  }
...
#line 56 "parser.y"
  {
    if ((yyvsp[0].num) == 0) {
      ...
      (yyval.num) = 0; // Default to 0 on error
    } else {
      (yyval.num) = (yyvsp[-2].num) / (yyvsp[0].num);
    }
  }
